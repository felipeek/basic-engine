...
_DEPS = camera.h collision.h common.h convex_bary_coords.h core.h gm.h graphics.h jarvis_march.h menu.h physics.h obj.h quaternion.h util.h
DEPS = $(patsubst %,$(SRCDIR)/%,$(_DEPS))

_OBJ = camera.o collision.o convex_bary_coords.o core.o graphics.o jarvis_march.o main.o menu.o physics.o obj.o quaternion.o util.o
