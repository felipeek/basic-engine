...
_DEPS = camera.h common.h core.h gjk.h gm.h graphics.h menu.h obj.h quaternion.h util.h
DEPS = $(patsubst %,$(SRCDIR)/%,$(_DEPS))

_OBJ = camera.o core.o gjk.o graphics.o main.o menu.o obj.o quaternion.o util.o
