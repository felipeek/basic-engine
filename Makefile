...
_DEPS = camera.h common.h core.h gjk.h gm.h graphics.h ho_gjk.o menu.h obj.h quaternion.h util.h
DEPS = $(patsubst %,$(SRCDIR)/%,$(_DEPS))

_OBJ = camera.o core.o gjk.o graphics.o ho_gjk.o main.o menu.o obj.o quaternion.o util.o
