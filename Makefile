...
_DEPS = camera.h common.h core.h gm.h graphics.h menu.h obj.h pbd.h quaternion.h util.h
DEPS = $(patsubst %,$(SRCDIR)/%,$(_DEPS))

_OBJ = camera.o core.o graphics.o main.o menu.o obj.o pbd.o quaternion.o util.o
