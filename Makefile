...
_DEPS = camera.h collision.h common.h core.h gm.h graphics.h menu.h physics.h obj.h quaternion.h util.h
DEPS = $(patsubst %,$(SRCDIR)/%,$(_DEPS))

_OBJ = camera.o collision.o core.o graphics.o main.o menu.o physics.o obj.o quaternion.o util.o
