...
_DEPS = camera.h common.h core.h gm.h graphics.h hierarchical_model.h menu.h obj.h quaternion.h util.h
DEPS = $(patsubst %,$(SRCDIR)/%,$(_DEPS))

_OBJ = camera.o core.o graphics.o hierarchical_model.o main.o menu.o obj.o quaternion.o util.o
