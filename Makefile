...
_DEPS = camera/camera.h camera/util.h camera/free.h camera/lookat.h common.h core.h gm.h graphics.h menu.h obj.h quaternion.h util.h
DEPS = $(patsubst %,$(SRCDIR)/%,$(_DEPS))

_OBJ = camera/camera.o camera/util.o camera/free.o camera/lookat.o core.o graphics.o main.o menu.o obj.o quaternion.o util.o
