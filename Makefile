...
_DEPS = animation.h camera.h common.h core.h gm.h graphics.h menu.h obj.h quaternion.h util.h
DEPS = $(patsubst %,$(SRCDIR)/%,$(_DEPS))

_OBJ = animation.o camera.o core.o graphics.o main.o menu.o obj.o quaternion.o util.o
