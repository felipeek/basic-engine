...
_DEPS = camera.h collision.h common.h core.h gm.h graphics.h menu.h obj.h physics.h quaternion.h util.h
DEPS = $(patsubst %,$(SRCDIR)/%,$(_DEPS))

_OBJ = camera.o collision.o core.o graphics.o main.o menu.o obj.o physics.o quaternion.o util.o
